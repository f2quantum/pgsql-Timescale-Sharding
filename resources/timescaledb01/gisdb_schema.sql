...
DROP SCHEMA IF EXISTS gisdb;
DROP SCHEMA IF EXISTS gisdb_0;
DROP SCHEMA IF EXISTS gisdb_1;



CREATE SCHEMA IF NOT EXISTS gisdb;
CREATE SCHEMA IF NOT EXISTS gisdb_0;
CREATE SCHEMA IF NOT EXISTS gisdb_1;
